...
class PairedSIMDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if len(stack) > 9:
            ...
            # elif self.nch_out > 1:
                # dim = (stack.shape[1]/self.opt['scale'])
                inputimg =stack[0:9,0:512,0:512] # !!! caution !!!
                # gt = stack[-self.nch_out:]
                gt = stack[4,0:512,0:512] # used to be index self.nch_in+1
            else:
                gt = stack[4,0:512,0:512] # used to be index self.nch_in+1
        else:
            inputimg =stack[0:3,0:512,0:512]
            gt = stack[4,0:512,0:512] # if it doesn't exist, doesn't matter
