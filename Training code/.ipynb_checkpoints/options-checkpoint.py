...
parser.add_argument('--ntrain', type=int, default=20, help='number of samples to train on')
...
parser.add_argument('--root', type=str, default='/E:/Users/ew535/Training datasets/Trained sets/06-06-2020/Training', help='dataset to train')
parser.add_argument('--server', dest='root', action='store_const', const='E:/Users/ew535/Training datasets/Trained sets/06-06-2020/Training', help='whether to use server root preset: /auto/homes/cnc39/phd/datasets')
parser.add_argument('--local', dest='root', action='store_const', const='/E:/Users/ew535/Training datasets/Trained sets/06-06-2020/Training', help='whether to use local root preset: C:/phd-data/datasets/')
...
parser.add_argument('--nch_in', type=int, default=9, help='colour channels in input') 
